...
def draw_monthly_mean_surface_plot(varName, yearStr, monthStr, regionStr, bgImage_filename,
                                   plot_filename_fullpath=None, draw_background_images=False,
                                   plot_data=True, draw_every=1, arrow_scale=10):

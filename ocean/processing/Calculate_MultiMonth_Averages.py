        ...
        self.config = \
            {'ersst':{
             ...
             'BRAN_eta':{
                ...
                'end_year': 2006,
                'end_month': 12,
                'input_dir': '/data/blue_link/data/monthly/eta/',
                'input_filename': 'eta_%(year)04d_%(month)02d.nc4',
                'output_dir': '/data/blue_link/data/averages/%(avg_period)dmonthly/eta/',
             ...
             'BRAN_temp':{
                ...
                'end_year': 2006,
                'end_month': 12,
                'input_dir': '/data/blue_link/data/monthly/temp/',
                'input_filename': 'temp_%(year)04d_%(month)02d.nc4',
                'output_dir': '/data/blue_link/data/averages/%(avg_period)dmonthly/temp/',
                'output_filename': '%(product_str)s_%(avg_period)dmthavg_%(date_str1)s_%(date_str2)s.nc4',
                'avg_periods': [3, 6, 12]},
             'BRAN_salt':{
                'product_str': 'bran2.1',
                ...
                'end_year': 2006,
                'end_month': 12,
                'input_dir': '/data/blue_link/data/monthly/salt/',
                'input_filename': 'salt_%(year)04d_%(month)02d.nc4',
                'output_dir': '/data/blue_link/data/averages/%(avg_period)dmonthly/salt/',
                'output_filename': '%(product_str)s_%(avg_period)dmthavg_%(date_str1)s_%(date_str2)s.nc4',
                'avg_periods': [3, 6, 12]},
             'BRAN_u':{
                'product_str': 'bran2.1',
                ...
                'end_year': 2006,
                'end_month': 12,
                'input_dir': '/data/blue_link/data/monthly/u/',
                'input_filename': 'u_%(year)04d_%(month)02d.nc4',
                'output_dir': '/data/blue_link/data/averages/%(avg_period)dmonthly/u/',
                'output_filename': '%(product_str)s_%(avg_period)dmthavg_%(date_str1)s_%(date_str2)s.nc4',
                'avg_periods': [3, 6, 12]},
             'BRAN_v':{
                'product_str': 'bran2.1',
                ...
                'end_year': 2006,
                'end_month': 12,
                'input_dir': '/data/blue_link/data/monthly/v/',
                'input_filename': 'v_%(year)04d_%(month)02d.nc4',
                'output_dir': '/data/blue_link/data/averages/%(avg_period)dmonthly/v/',
                'output_filename': '%(product_str)s_%(avg_period)dmthavg_%(date_str1)s_%(date_str2)s.nc4',
                'avg_periods': [3, 6, 12]}
            }
